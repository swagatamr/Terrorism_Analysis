# -*- coding: utf-8 -*-
"""
Created on Fri Oct 16 23:40:16 2020
...
# Creating Dash object and styling the UI using Bootstrap
        ...
        html.Footer(id="footer",
                    ...
                    children=[
                        ...
                        html.H3(style={"text-align": "center"}, children=[
                            html.H3(children="Made by SWAGATAM ROY ", style={"display": "inline"}),
                        ]),

                        # Email of the creator
                        html.H6(style={"text-align": "center"}, children=[
                            html.H6(children="Email: swagatamr577@gmail.com", style={"display": "inline"}),
                        ]),

                        # Linkedin profile of the creator
                        html.H6(style={"text-align": "center"}, children=[
                            html.H6(children="Linkedin: https://www.linkedin.com/in/swagatam-roy-32a457171/", style={"display": "inline"}),
                            html.Br(),
                            modal,
...
def update_app_ui(Tabs, month_value, date_value, region_value, country_value, state_value, city_value, attack_value,
    ...
    if Tabs == "Map":
        ...
        mapFigure.update_layout(mapbox_style="white-bg",
                                mapbox_layers=[
                                    {
                                        "below": 'traces',"sourcetype": "raster","source": [
